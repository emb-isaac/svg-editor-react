	...
	return (
		<>
			<div key={props.color} class="form-group">
				...
				<input type="text" className="form-control-sm" name={props.color} value={props.color} style={{ borderColor: props.color }} readonly />
				
				<label className="small form-text">Recolor</label>
				<select className="form-control-sm recolor-list mt-0" name="recolor1" id="recolor1" onChange={handleRecolor} style={{ borderColor: recolor??'' }} >
